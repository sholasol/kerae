<div>
    ...
    <div class="dasboard-wrapper fl-wrap no-pag">
        ...
        <form wire:submit.prevent="createListing"  enctype="multipart/form-data">
            @csrf
            ...
            <div class="custom-form">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input wire:model="propertytitle" type="text" placeholder="Name of your Model"/>
                    ...
                    <div class="col-sm-4">
                        ...
                        <input wire:model="price" type="number" value="10" placeholder="Model Price"/>
        ...
        <div class="dasboard-widget-box   fl-wrap">
            <div class="custom-form">
                <div class="row">
                    <div class="col-sm-4">
                        <label>Estate  <span class="dec-icon" style="border: none"></span></label>
                            <select wire:model="estate" class="chosen-select no-search-select" >
                                <option selected> -- select --</option>
                                @foreach ($ests as $est)
        ...
        <div class="dasboard-widget-box fl-wrap">
            ...
            <div class="custom-form">
                ...
                <div class="listsearch-input-item fl-wrap">
                    ...
                    {{-- <input wire:model="propertyImages" type="file" multiple/> --}}
                    {{-- @error('propertyImages')<p class="text-danger">{{ $message }}</p> @enderror --}}
