    ...
    <div class="dasboard-wrapper fl-wrap">
        <div class="dasboard-listing-box fl-wrap">
            <div class="dasboard-opt sl-opt fl-wrap">
                ...
                <a href="{{route('estate')}}" class="gradient-bg dashboard-addnew_btn">Add New <i class="fal fa-plus"></i></a>
                <!-- price-opt-->
                <div class="price-opt">
                    ...
                    <div class="col-md-6">
                        <div class="dashboard-listings-item fl-wrap" style="height: 190px">
                            <div class="dashboard-listings-item_img">
                                ...
                                <a href="{{route('estates', ['code'=>$list->code])}}" target="_blank" class="color-bg">View</a>
                            ...
                            <div class="dashboard-listings-item_content">
                                ...
                                <div class="dashboard-listings-item_opt">
                                    <?php
                                            if (strlen($list->description)>200) {
                                                $note= Str::substr($list->description, 0, 100);
                                                echo "$note"."...]";
                                            }else {
