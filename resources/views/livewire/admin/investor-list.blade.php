                    ...
                    <div class="col-md-12">
                        <div class="bookings-item fl-wrap">
                            <div class="moveem">
                                ...
                                <ul>
                                    <li>Full Name: <span>{{$investor->fullname}}</span></li>
                                    <li>Phone Number: <span>{{$investor->phone}}</span></li>
                                    <li>Address Email: <span>{{$investor->email}}</span></li>
                                    <li>Project of interest: <span>{{$investor->project}}</span></li>
                                    <li>Date of investment: <span>{{$investor->invdate}}</span></li>
                                    <li>Investment Period: <span>{{$investor->invperiod}}</span></li>
                                    <li>Investment Amount: <span>{{$investor->invamount}}</span></li>
                                </ul>
                            ...
                            <div class="bookings-item-footer fl-wrap" style="padding-bottom: 15px">
                                <span class="message-date">Applied: {{$investor->created_at->DiffForHumans()}}</span>
                                {{-- <ul>
                                    <li><a href="{{route('updateinvestor', ['investor'=>$investor->id])}}" class="tolt" data-microtip-position="top-left"  data-tooltip="Write"><i class="far fa-edit"></i></a></li>
